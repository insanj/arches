...
class ArchesExtractorFrontend {
	...
	handleFinishedReadingTextFromFileUI(file, fr, markup) {
        $(this.parentDivSelector).append("<button type='button' class='btn btn-primary' id='"+arches_extractButtonID+"'><i class='fa fa-cog' aria-hidden='true'></i> Transform</button>");
        var selfRef = this;
